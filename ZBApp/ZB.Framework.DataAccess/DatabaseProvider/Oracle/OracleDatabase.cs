...
namespace ZB.Framework.DataAccess.Oracle
{
    using Configuration;
    ...
    /// <remarks>
    /// <para>
    /// Internally uses an ODP.NET Managed Provider from Oracle (<see cref="Oracle.DataAccess.Client"/>) to connect to an Oracle 9i, or newer, database.
    /// </para>
    /// <para>
    ...
    [ConfigurationElementType(typeof(Microsoft.Practices.EnterpriseLibrary.Data.Oracle.Configuration.OracleDatabaseData))]
    public class OracleDatabase : Database
    {
        ...
        public static OracleCommand CheckIfOracleCommand(DbCommand command)
        {
            ...
            if (oracleCommand == null)
                throw new ArgumentException("The command must be an OracleCommand.", "command");
