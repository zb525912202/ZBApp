...
{
    public class ZBPQEXRockeyArm : ZBSecrecyObjBase
    {
        /// <summary>
        /// 过期日期
        /// </summary>
        ...
        public static void LoadBytes(SmartObjectSerializer serializer, ZBPQEXRockeyArm obj)
        {
        ...
        public static void LoadObj(SmartObjectDeserializer deserializer, ZBPQEXRockeyArm obj)
        {
