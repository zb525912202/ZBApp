...
{
    public class CodeWriter_ZBWebSite
    {
        private string _TemplateFileName_Table = System.Windows.Forms.Application.StartupPath + "\\Project\\ZBWebSite\\Template\\TableTemplate.cs";
        private string _TemplateFileName_TableJS = System.Windows.Forms.Application.StartupPath + "\\Project\\ZBWebSite\\Template\\TableJS.js";

        private Dictionary<string, string> DataTypeDefine_CS = new Dictionary<string, string>();
        private Dictionary<string, string> DataTypeDefine_JS = new Dictionary<string, string>();

        public DBManager Dbmgr;

        public ZBDatabase CurrentDatabase;

        public CodeWriter_ZBWebSite()
        {
            ...
            //JS
            DataTypeDefine_JS.Add("char", "string");
            DataTypeDefine_JS.Add("nchar", "string");
            DataTypeDefine_JS.Add("varchar", "string");
            DataTypeDefine_JS.Add("nvarchar", "string");
            DataTypeDefine_JS.Add("text", "string");
            DataTypeDefine_JS.Add("int", "int");
            DataTypeDefine_JS.Add("bigint", "int");
            DataTypeDefine_JS.Add("float", "float");
            DataTypeDefine_JS.Add("real", "float");
            DataTypeDefine_JS.Add("datetime", "date");
            DataTypeDefine_JS.Add("bit", "boolean");
            DataTypeDefine_JS.Add("numeric", "int");
            DataTypeDefine_JS.Add("decimal", "float");
            DataTypeDefine_JS.Add("ntext", "string");
            DataTypeDefine_JS.Add("uniqueidentifier", "string");
                           
            DataTypeDefine_JS.Add("image", "byte[]");
            DataTypeDefine_JS.Add("varbinary", "byte[]");
            DataTypeDefine_JS.Add("varbinary(max)", "byte[]");
        }
        ...
        public void WriteCodeFile(DBManager dbmgr, string dbName, string placeFolder, string namespacePrefix)
        {
            ...
            foreach (var tableItem in dbmgr.GetDBByName(dbName).TableList.Where(r => r.IsInclude))
            {
                ...
                StringBuilder sb2 = new StringBuilder(File.ReadAllText(_TemplateFileName_TableJS, Encoding.UTF8)); //sb2=js
                sb2.Replace("%Namespace%", namespacePrefix + "." + tableItem.ObjectName);


                //逐个列生成Property段
                string strProperties_sb1 = string.Empty;

                string strProperties_sb2 = string.Empty;
                ...
                foreach (var columnItem in tableItem.ColumnList)
                {
                    ...
                    string dataTypeStrJS = DataTypeDefine_JS[columnItem.DataType];

                    string strPropItem_sb1 = string.Empty;
                    string strPropItem_sb2 = string.Empty;
                    ...
                    ///sb2
                    strPropItem_sb2 = s_sb2_normal.Replace("#ColumnName#", columnItem.ObjectName);
                    strPropItem_sb2 = strPropItem_sb2.Replace("#DataType#", dataTypeStrJS);
                    strProperties_sb2 += strPropItem_sb2;
                    strProperties_sb2 += System.Environment.NewLine;
                ...
                sb2.Replace("%Properties%", strProperties_sb2);
                ...
                string CodeFileName_sb2 = placeFolder + "\\" + tableItem.ObjectName + ".js";
                ...
                if (File.Exists(CodeFileName_sb2)) File.Delete(CodeFileName_sb2);

                using (StreamWriter sw = new StreamWriter(CodeFileName_sb2))
                {
